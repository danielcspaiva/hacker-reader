...
import { controlSize, foregroundStyle, frame } from "@expo/ui/swift-ui/modifiers";
          ...
          <ContextMenu>
            ...
            <ContextMenu.Trigger>
              <SwiftUIButton
                ...
                modifiers={[foregroundStyle(textColor), controlSize("small"), frame({ width: 24, height: 24 })]}
              />
            </ContextMenu.Trigger>
          </ContextMenu>
        </Host>
