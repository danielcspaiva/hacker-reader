          ...
          <div className="mx-auto max-w-6xl px-6 sm:px-10">
            <div className="grid gap-16 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              ...
              <div className="space-y-6 rounded-3xl border border-[#ead9c9] bg-[#fefaf4] p-10 shadow-[0_25px_60px_rgba(210,180,150,0.28)] dark:border-[#252525] dark:bg-[#0c0c0c] dark:shadow-[0_30px_70px_rgba(0,0,0,0.55)]">
                <h3 className="text-2xl font-semibold">Performance First</h3>
                <ul className="space-y-4 text-base leading-relaxed text-[#5d5146] dark:text-[#c2c2c2]">
                  <li>⚡ Instant category switching with React Query caching</li>
                  <li>🚀 Smooth 60fps scrolling through thousands of stories</li>
                  <li>🌓 Seamless light/dark mode transitions</li>
                  <li>🔐 Secure HN authentication with session persistence</li>
                </ul>
              </div>
            </div>
          </div>
